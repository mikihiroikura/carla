...
def translateEv2Img(eventArray):
    ...
    # Image show
    # cv2.imshow('Event image', eventImg)
    # cv2.waitKey(1)

    # Save event images
    imgpath = '/home/mikura/Github/carla/tutorial/output/%.6d.jpg' % eventArray.frame
    cv2.imwrite(imgpath, eventImg)
...
def main():
    ...
    try:
        ...
        # Start recording
        # --------------
        print("Recording on file: %s" % client.start_recorder('/home/mikura/Github/carla/tutorial/recorder/recording01.log'))
        ...
        ego_cam.listen(lambda image: image.save_to_disk('/home/mikura/Github/carla/tutorial/output/%.6d.jpg' % image.frame))
        """
        
        # --------------
        # Add a DVS sensor to stable points.
        # --------------
        dvs_bp = None
        ...
        stable_dvs.listen(lambda eventArray: translateEv2Img(eventArray))
